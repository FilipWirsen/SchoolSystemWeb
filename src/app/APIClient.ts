...
export class Client {
     ...
     * @return Success
     */
    createStudent(body: Student | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/students/createStudent";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getStudent(id: number): Observable<Student> {
        let url_ = this.baseUrl + "/api/students/getStudent/{id}";
    ...
    protected processGetStudent(response: HttpResponseBase): Observable<Student> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getAllStudents(): Observable<Student[]> {
        let url_ = this.baseUrl + "/api/students/getAllStudents";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    updateStudent(id: string, body: Student | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/students/updateStudent/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    deleteStudent(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/students/deleteStudent/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
